/**
 * ============================================================
 * ARCHIVO: seguridad_exacta.js
 * ============================================================
 */
let advertenciasSeguridad = parseInt(localStorage.getItem('advertencias_exactas')) || 0;
...
function registrarInfraccion() {
    ...
    localStorage.setItem('advertencias_exactas', advertenciasSeguridad);
    domContadorAdv.innerText = advertenciasSeguridad;
