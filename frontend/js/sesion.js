...
(async function () {
    ...
    if (boletaActiva && sessionToken) {
        try {
            ...
            const respuesta = await fetch('https://www.bitacora.cecyt14.ipn.mx/api/examen/verify', {
                method: 'POST',
    ...
    window.cerrarSesion = async function() {
        ...
        try {
            ...
            if (areaEnCurso && boletaActual) {
                ...
                await fetch('https://www.bitacora.cecyt14.ipn.mx/api/examen/entregar', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
                        boleta: boletaActual,
            ...
            if (boletaActual) {
                await fetch('https://www.bitacora.cecyt14.ipn.mx/api/examen/logout', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
